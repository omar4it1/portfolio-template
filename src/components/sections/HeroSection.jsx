        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              <motion.h1
                variants={itemVariants}
                className="text-3xl md:text-4xl font-light mb-6 leanding-tight"
              >
                <span
              ...
              >
                ...
                <motion.button
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => scrollToSection('mailto:aamir.latif@gmail.com')}
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              <motion.h1
                variants={itemVariants}
                className="text-5xl md:text-7xl font-light mb-8 leanding-tight"
              >
                <span
                  className={`${isDarkMode ? "text-white" : "text-gray-900"}`}
                >
              ...
              <motion.div variants={itemVariants} className="flex gap-6 mb-8">
                <motion.button
                  ...
                  rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300">
                  View Work
                </motion.button>
                <motion.button
                  whileHover={{ y: -2 }}
                  ...
                  className={`border ${isDarkMode ? "border-gray-600 text-gray-400 hover:bg-gray-800" :
                      "border-gray-400 text-gray-600 hover:bg-gray-100"
                    } px-8 py-3 rounded-full text-sm uppercase tracking-wider 
