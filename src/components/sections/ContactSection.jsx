        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
                <motion.div
                    ...
                    className={`text-sm uppercase tracking-wider ${isDarkMode ? "text-gray-500" : "text-gray-600"
                        } mb-4`}
                >
                    Let's Connect
                </motion.div>
                ...
                >
                    Ready to start next project? Let's discuss how we bring
                    your ides to life
                </motion.p>
            </motion.div>
